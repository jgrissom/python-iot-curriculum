...
> [!TIP]
> **Do this:** run it and watch a song for a while — melodies have *shape*, and the bar makes it visible: scales climb the strip, octave jumps leap it, rests snap it dark. Then make it yours:
